...
g++ -fPIC -shared -o libs/build/libTEA.so ciphers/tea/tea.cpp

g++ launcher.cpp -o cryptDeck libs/build/libKeygen.so libs/build/libVernam.so libs/build/libVigenere.so libs/build/libDoubleTransposition.so libs/build/libTEA.so
